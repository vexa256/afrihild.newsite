                         ...
                         <div class="col col-lg-4 col-md-8 col-12 mb-4">
                             <div class="wpo-blog-item">
                                <div class="wpo-blog-img">
                                    <img src="{{ asset($data->URL) }}" style="width: 100%; height: 40vh;">
                                </div>
                                 <div class="wpo-blog-content">
                                     <div class="wpo-blog-content-top mb-3">
                                         ...
                                         <p class="pt-1"
                                         style="height: 30vh; overflow-y: scroll; text-align: justify; padding-left: 10px; padding-right: 10px; text-transform: capitalize; ">
                                         <span class="fw-bolder" style="color: #de0b81; "> {{ ucfirst($data->Name) }}</span> <br>
