             ...
             <div class="col-12">
                 <div class="wpo-breadcumb-wrap">
                     ...
                     <ul>
                         ...
                         <li><span>Research Associates</span></li>
                     </ul>
                 </div>
             </div>
         </div>
                         ...
                         <div class="col col-lg-4 col-md-8 col-12 mb-4">
                             <div class="wpo-blog-item">
                                 <div class="wpo-blog-img"
                                     style="background-repeat:no-repeat; background-size:70%; background-position: center; height: 30vh; background-image: url({{ asset($data->URL) }})">
                                     {{-- <img src=""
                                 ...
                                 <div class="wpo-blog-content">
                                     <div class="wpo-blog-content-top mb-3">
                                         ...
                                         <p class="pt-5"
                                             style="height: 15vh; overflow-y: scroll; text-align: justify; padding-left: 10px; padding-right: 10px
                 ">
